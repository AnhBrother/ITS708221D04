...
<html lang="en">
  ...
  <body>
    ...
    <div class="head-banner" id="head-banner">
      <b style ="font-size:70px"><center><?php echo $row['Name']?></center></b>
    </div>
    ...
    <div class="review" id="review">
      ...
      <div class="certificate-content">
        ...
        <div class="certificate-imgDiv">
          <img
            src="./components/icons/Course.jpg"
            alt=""
          />
        </div>
      </div>
    ...
    <div class="certificate" id="certificate">
      <h2 font-size: 29px> <center>CERTIFICATE</center></h2>
      <div id="enrollment-opt">
      <div>
        <h2>Start Date</h2>
        <p><b style = "font-size: 20px"><?php echo $row['Created_date']?></b></p><br>
        <b style ="font-size:25px";>Level:  </b> <span style ="font-size:20px";><?php echo $row['For_level']?> </span>
        </br>
        </br>
        <b style ="font-size:25px";>Rate:  </b> <span style ="font-size:20px";><?php echo $row['Average_star_review']?> </span>
        </br>
        </br>     
